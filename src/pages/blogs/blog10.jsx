...
import school1Img from "../../assets/School1.jpg";
      ...
      <div className="blog-wrapper">
        ...
        <header className="blog-header">
          <div className="hero-background-container">
            <img src={heroImg} alt="School Establishment" className="hero-image" />
            <div className="hero-overlay-gradient"></div>
          </div>
          
          <div className="hero-text-content">
            <div className="meta-info-row">
              <span className="meta-item"><FaRegCalendarAlt /> March 30, 2026</span>
              <span className="meta-item"><FaRegClock /> 5 Min Read</span>
            </div>
            <h1 className="main-title">
              How to Start a <span className="accent-text">School</span> <br />
              The SES Blueprint
            </h1>
          </div>
        </header>
          ...
          <main className="blog-body">
            <section className="content-segment">
              <p className="intro-text">
                <span className="first-letter">S</span>tarting a school is a structured process 
                that blends academic vision with meticulous regulatory execution. Whether it’s a 
                primary or senior secondary institution, every stage must align with board guidelines 
                to ensure long-term credibility and sustainability.
              </p>
            </section>

            {/* SECTION 1 - PLANNING */}
            <section className="article-section">
              <h2 className="section-title">Academic Vision</h2>
              <p className="section-para">
                The foundation begins with defining your curriculum pattern and board selection. 
                SES helps promoters create a clear academic roadmap that balances 
                modern teaching methodologies with state and national regulatory norms.
              </p>
              
              <div className="compliance-checklist">
                <div className="check-item">
                  <FaSchool className="check-icon" />
                  <div>
                    <h4>Infrastructure Readiness</h4>
                    <p>Guidance on classroom design, labs, and safety norms.</p>
                  </div>
                </div>
                <div className="check-item">
                  <FaChalkboardTeacher className="check-icon" />
                  <div>
                    <h4>Staffing & Recruitment</h4>
                    <p>Selecting qualified educators to uphold academic standards.</p>
                  </div>
                </div>
              </div>

              <div className="content-image-box">
                <img src={school1Img} alt="School Planning Process" />
              </div>
            </section>
            ...
            <section className="article-section">
              ...
              <p className="section-para">
                Establishment requires coordination between legal documentation, affiliation 
                readiness, and operational planning. SES guides you through each phase 
                to avoid administrative delays and ensure a smooth launch.
              </p>
              <div className="content-image-box">
                <img src={school2Img} alt="School Operations" />
              </div>
            </section>
            ...
            <section className="video-card">
              <div className="video-info">
                <FaUserGraduate className="video-icon-svg" />
                <h3>The Roadmap to Excellence</h3>
                <p>Watch our step-by-step guide on how we simplify the school establishment process for promoters.</p>
              </div>
              <div className="iframe-wrapper">
                <iframe
                  src="https://player.cloudinary.com/embed/?public_id=starting-a_-school-guide_yhdv1u&cloud_name=dqmkivr5i&fluid=true"
                  title="School Startup Guide Video"
            ...
            <section className="conclusion-box">
              ...
              <p className="section-para">
                Starting a school becomes effortless with structured execution. 
                With SES, your vision for education transforms into a compliant 
          ...
          <aside className="blog-sidebar">
            <div className="sticky-container">
              <div className="sidebar-card insights">
                ...
                <div className="insight-links">
                  <a href="/blogs/blog9" className="link-item">
                    <img src={blog1Img} alt="Compliance" />
                  ...
                  <a href="/blogs/blog7" className="link-item">
                    <img src={blog2Img} alt="Blueprint" />
                    <div className="link-text">
              ...
              <div className="sidebar-card expert">
                ...
                <h3>Expert Setup</h3>
                <p>Consult with us to start your school with professional precision.</p>
