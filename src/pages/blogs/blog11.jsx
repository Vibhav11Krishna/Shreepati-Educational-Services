...
// Assets
import heroImg from "../../assets/Banner11.jpg";
import approvalImg1 from "../../assets/School3.jpg";
import complianceImg from "../../assets/School4.jpg";
      ...
      <div className="blog-wrapper">
        ...
        <header className="blog-header">
          <div className="hero-background-container">
            <img src={heroImg} alt="Government Approvals" className="hero-image" />
            <div className="hero-overlay-gradient"></div>
          </div>
          
          <div className="hero-text-content">
            <div className="meta-info-row">
              <span className="meta-item"><FaRegCalendarAlt /> April 2, 2026</span>
              <span className="meta-item"><FaRegClock /> 6 Min Read</span>
            </div>
            <h1 className="main-title">
              Government <span className="accent-text">Approvals</span> <br />
              Simplified for Schools
            </h1>
          </div>
        </header>
          ...
          <main className="blog-body">
            <section className="content-segment">
              <p className="intro-text">
                <span className="first-letter">G</span>overnment approvals are the backbone of a 
                legitimate educational institution. These certifications ensure that your school meets 
                the mandatory academic standards, safety norms, and legal frameworks required for 
                long-term operation. Navigating this landscape requires precision to avoid 
            ...
            <section className="article-section">
              <h2 className="section-title">Navigating the Approval Maze</h2>
              <p className="section-para">
                SES acts as a strategic partner, assisting institutions in preparing meticulous 
                documentation and understanding complex timelines. From initial recognition 
                certificates to final board affiliations, we ensure your paperwork is error-free.
              </p>
              
              <div className="compliance-checklist">
                <div className="check-item">
                  <FaFileContract className="check-icon" />
                  <div>
                    <h4>Documentation Audit</h4>
                    <p>Rigorous review of land records, trust deeds, and safety certificates.</p>
                  </div>
                </div>
                <div className="check-item">
                  <FaStamp className="check-icon" />
                  <div>
                    <h4>Board Affiliation</h4>
                    <p>Streamlined coordination with state and central educational boards.</p>
                  </div>
                </div>
              </div>

              <div className="content-image-box">
                <img src={approvalImg1} alt="Government Documentation Support" />
              </div>
            </section>

            {/* SECTION 2 - INSPECTION */}
            <section className="article-section">
              <h2 className="section-title">Inspection & Compliance Readiness</h2>
              <p className="section-para">
                Physical inspections are the most critical stage. SES prepares your institution 
                by conducting pre-inspection audits, ensuring your infrastructure, staff records, 
                and safety protocols meet the prescribed standards perfectly.
              </p>
              <div className="content-image-box">
                <img src={complianceImg} alt="School Compliance Inspection" />
              </div>
            </section>
            ...
            <section className="video-card">
              <div className="video-info">
                <FaSearchPlus className="video-icon-svg" />
                <h3>The Approval Workflow</h3>
                <p>Watch our detailed guide on the mandatory legal steps required to clear government inspections and secure your school's future.</p>
              </div>
              <div className="iframe-wrapper">
                <iframe
                  src="https://player.cloudinary.com/embed/?public_id=governemnt-approvals-school_nmn6sq&cloud_name=dqmkivr5i&fluid=true"
                  title="Government Approval Guide"
            ...
            <section className="conclusion-box">
              ...
              <p className="section-para">
                Securing government approvals doesn't have to be a bottleneck. With the right 
                expertise and planning, you can move through regulatory hurdles smoothly 
                and focus on what matters most: educating students.
              </p>
            </section>
          </main>
            ...
            <div className="sticky-container">
              ...
              <div className="sidebar-card expert">
                <div className="expert-avatar">
                  <img src={blogSidebar2} alt="SES Legal Expert" />
                </div>
                <h3>Approval Help</h3>
                <p>Let our legal experts handle your school's documentation and affiliation process.</p>
