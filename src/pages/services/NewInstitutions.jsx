...
const documentChecklist = [
  { title: "Project Report (DPR)", detail: "10-year roadmap for the college" },
  { title: "CLU Document", detail: "Legal land-use conversion permit" },
  { title: "Site Blueprints", detail: "Architectural maps of labs/blocks" },
  { title: "Endowment Proof", detail: "Required reserve fund bank records" },
  { title: "Regulatory App", detail: "Prepared AICTE/UGC entry forms" },
  { title: "Library Register", detail: " List of titles per minimum norms" },
];
