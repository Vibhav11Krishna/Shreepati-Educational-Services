...
const documentChecklist = [
  { title: "SSR Report", detail: "Self-study data for NAAC/NBA" },
  { title: "AQAR Files", detail: "Annual quality assurance records" },
  { title: "Research List", detail: "Faculty journal publications/books" },
  { title: "Progression Data", detail: "Student placement/higher study logs" },
  { title: "ICT Proofs", detail: " Evidence of smart classrooms and labs" },
  { title: "Feedback Logs", detail: "Surveys from students and alumni" },
];
const outcomes = [
  {
    icon: <FaChalkboardTeacher size={40} />,
