...
import blog1 from "../../assets/Report.jpg";
import blog2 from "../../assets/Planning.jpg";
import blog3 from "../../assets/Support.jpg";
import {
  FaChalkboardTeacher,
  FaLightbulb,
  FaUniversity,
...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Every report is tailored to the institution’s vision, goals, and resources. ",
  },
  {
    icon: <FaCheckCircle size={30} />,
...
const documentChecklist = [
  { title: "Feasibility Study", detail: "Market demand and competition data" },
  { title: "3-Year Projection", detail: "Estimated P&L and cash flow" },
  { title: "Infrastructure Audit", detail: " Gap analysis of physical assets" },
  { title: "Fund Flow", detail: "Documentation of capital sources" },
  { title: "Academic Plan", detail: " Proposed departments and courses" },
  { title: "Risk Report", detail: "Mitigation strategy for legal/market risks" },
];
const outcomes = [
  {
    icon: <FaChalkboardTeacher size={40} />,
...
const blogs = [
  {
    image: blog1,
    title: "Importance of DPRs",
    description:
      "Detailed Project Report helps plan finances, academics, and infrastructures",
    link: "/blogs/blog13",
  },
  {
    image: blog2,
    title: "Planning Educational Projects",
    description:
      "How SES ensures smooth execution from concept to completion",
    link: "/blogs/blog14",
  },
  {
    image: blog3,
