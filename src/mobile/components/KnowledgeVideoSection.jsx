...
function KnowledgeVideoSection() {
  ...
  return (
    <section
      id="knowledge-videos"
      style={{ padding: "20px", background: "#fdf6f0", fontFamily: "'Poppins', sans-serif" }}
    >
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        ...
        <div className="video-grid">
          {videoList.map((item, index) => (
            <div
              key={index}
              className={`video-card ${loaded ? "visible" : ""}`}
        ...
        {/* View All Videos Button (goes to Desktop component) */}
        <div style={{ textAlign: "center", marginTop: "40px", marginBottom: "60px" }}>
          <button
            onClick={() => navigate("/all-knowledge-videos")} 
            style={{
              padding: "12px 28px",
              background: "linear-gradient(90deg, #FF6600, #D32F2F)",
              color: "#fff",
      ...
      {/* FAQ CTA */}
      <div style={{ marginTop: "60px", textAlign: "center", padding: "0 14px" }}>
        <h4
          style={{
            textAlign: "center",
            color: "#FF6600",
        ...
        <p style={{ fontSize: "1rem", color: "#FF6600", marginBottom: "26px" }}>
      ...
      <style>{`
        ...
        .video-card { opacity: 0; transform: translateY(20px); transition: all 0.6s ease; }
